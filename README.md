...
### 1. Добавлена проверка входных на верный тип данных. Проверка Url формата реализованна при помощи стороней библиотеки Pydantic, что делает вид листинга программы удобнее для прочтения. 
```py
Файл fileworker.py
